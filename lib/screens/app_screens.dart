...
import '../models/data_models.dart'; // Zde je FaithType
          ...
          SafeArea(
            child: Padding(
              ...
              child: Column(
                children: [
                  const Spacer(),
                  const PrayaLogo(size: 90)
                      .animate()
                      .scale(duration: 1000.ms, curve: Curves.elasticOut),
                  const SizedBox(height: 20),
                  Text("Drop of Hope. Shared by Humanity.",
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: const InputDecoration(
                              hintText: "Tvé jméno (Poutník)",
                              hintStyle: TextStyle(color: Colors.white30),
                              border: InputBorder.none),
                        ),
                        const Divider(color: Colors.white10),
                        const SizedBox(height: 10),
                        const Text("Kde hledáš sílu?",
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        context.read<AppState>().login(
                            _nameCtrl.text.isEmpty ? "Poutník" : _nameCtrl.text,
                            _selectedFaith);
                      },
      ...
      body: Stack(
        children: [
          ...
          Align(
              ...
              child: _buildAdvancedDock(context, state)),
          Positioned(
            bottom: 120,
            right: 20,
            child: FloatingActionButton(
              ...
              child: const Icon(Icons.auto_awesome, color: Colors.white)
                  ...
                  .shimmer(duration: 2000.ms, color: state.moodColor),
  ...
  Widget _buildAdvancedDock(BuildContext context, AppState state) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: const Color(0xFF0A0A12).withValues(alpha: 0.8),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                      colors: [state.moodColor, Colors.purple]),
                  boxShadow: [
                    BoxShadow(
                        color: state.moodColor.withValues(alpha: 0.4),
                        blurRadius: 15)
                  ]),
              child: const Icon(Icons.add, color: Colors.white, size: 28),
            ),
          )
              .animate(target: state.navIndex == 2 ? 1 : 0)
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            shape: BoxShape.circle),
        child: Icon(icon,
            color: active ? state.moodColor : Colors.white38, size: 24),
      ),
    );
  }
}
    ...
    return SingleChildScrollView(
        ...
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Icon(Icons.notifications_none, color: Colors.white38)
          ]),
          const SizedBox(height: 20),
          // SOUL DASHBOARD
          GlassPanel(
              ...
              child: Column(children: [
                Row(children: [
                  Icon(Icons.park, color: state.moodColor),
                  const SizedBox(width: 10),
                  Text(state.getLevelData(state.level).title.toUpperCase(),
                  ...
                  Text("Level ${state.level}",
                      style: TextStyle(color: state.moodColor))
                ]),
                const SizedBox(height: 15),
                LinearProgressIndicator(
                    value: (state.auraPoints % 500) / 500,
                ...
                Row(
                    ...
                    children: [
                      Text("${state.auraPoints} XP",
                          style: const TextStyle(
                              fontSize: 10, color: Colors.white54)),
                      Text(
                          "Do dalšího: ${(state.level * 500) - state.auraPoints} XP",
                          style:
                              TextStyle(fontSize: 10, color: state.moodColor))
                    ])
              ])),
          ...
          GlassPanel(
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                const Text("Biofeedback",
                    style: TextStyle(fontSize: 12, color: Colors.white54)),
                Icon(Icons.circle, size: 8, color: state.moodColor)
              ...
              SliderTheme(
                  data: SliderThemeData(
                      ...
                      activeTrackColor: state.moodColor,
          ...
          if (state.visibleFeed.isEmpty)
            const Padding(
                ...
                child: Text("Řeka je klidná...",
                    style: TextStyle(color: Colors.white38))),
          ...state.visibleFeed
              .map((item) => _buildEnhancedCard(context, item, state)),
      ...
      child: GlassPanel(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Center(
              child: Opacity(
                  opacity: 0.7,
                  child: SoulSignatureWidget(
                      text: item.originalText, seedColor: item.artSeedColor))),
          const SizedBox(height: 15),
          AnimatedSwitcher(
              duration: 300.ms,
              child: Text(
                  ...
                  style: const TextStyle(
                      fontSize: 16, height: 1.4, color: Colors.white70))),
          const SizedBox(height: 10),
          GestureDetector(
        ...
        builder: (ctx) => Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              ListTile(
                  ...
                  title: const Text("Nenávistný projev",
              ...
              ListTile(
                  ...
                  title: const Text("Spam nebo reklama",
                      style: TextStyle(color: Colors.white)),
                  onTap: () {
                    state.reportPost(id);
                    Navigator.pop(context);
              ...
              ListTile(
                  leading: const Icon(Icons.sentiment_very_dissatisfied,
                      color: Colors.blue),
                  title: const Text("Negativní energie",
                      style: TextStyle(color: Colors.white)),
                  onTap: () {
                    state.reportPost(id);
                    Navigator.pop(context);
...
class JourneyScreen extends StatelessWidget {
                ...
                Expanded(
                    child: GestureDetector(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: !state.showJournal
                                    ? Colors.white10
                                    : Colors.transparent,
                                borderRadius: BorderRadius.circular(15)),
                            child: const Center(
                                child: Text("Mapa Cesty",
                                    style: TextStyle(color: Colors.white)))))),
                Expanded(
                    child: GestureDetector(
          ...
          if (!state.showJournal) ...[
            ...
            ...state.milestones.map((milestone) {
              ...
              return Column(children: [
                _buildNode(context, milestone, data.title, unlocked, isCurrent,
                    state, data.perk),
                ...
                child: GlassPanel(
                    child: Column(
                      ...
                      item.privateNotes.isEmpty
                          ? GestureDetector(
                              onTap: () =>
                                  _addNoteDialog(context, state, item.id),
                              child: const Text("+ Přidat poznámku",
                                  style: TextStyle(color: Colors.white38)))
                          : Column(
                              children: item.privateNotes
                                  .map((n) => Padding(
                                      padding:
  ...
  Widget _buildNode(BuildContext context, int lvl, String title, bool unlocked,
      bool isCurrent, AppState state, String perk) {
    return GlassPanel(
        ...
        child: Row(children: [
          Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                  color: unlocked ? state.moodColor : Colors.white10,
                  shape: BoxShape.circle,
                  boxShadow: unlocked
                      ? [BoxShadow(color: state.moodColor, blurRadius: 15)]
                      : []),
              child: Icon(unlocked ? Icons.star : Icons.lock,
                  color: unlocked ? Colors.white : Colors.white24, size: 20)),
              ...
              child: Column(
                ...
                Text(title,
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.bold,
                        fontSize: 16)),
                Text("Level $lvl • Odměna: $perk",
                    style:
                        const TextStyle(color: Colors.white38, fontSize: 10)),
                if (isCurrent)
                  Text("SOUČASNÁ ÚROVEŇ",
                      style: TextStyle(
                          color: state.moodColor,
                          fontSize: 10,
                          fontWeight: FontWeight.bold))
  ...
  Widget _buildLine({bool active = false}) {
    return Container(
        ...
        width: 2,
        height: 20,
        color: active ? Colors.white54 : Colors.white10);
  }
    ...
    showDialog(
        ...
        builder: (ctx) => AlertDialog(
                ...
                content: TextField(
                    ...
                    decoration: const InputDecoration(
                        hintText: "Co tě na tom oslovilo?",
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            if (_ctrl.text.isNotEmpty) {
                              context
                                  .read<AppState>()
                                  .createPost(_ctrl.text, _stressVal);
                              context.read<AppState>().setIndex(0);
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text("Signál odeslán. +50 Bodů."),
    ...
    return SingleChildScrollView(
        ...
        child: Column(
            ...
            children: [
              ...
              const Text("Analýza dopadu modlitby (Real-time data)",
                  style: TextStyle(color: Colors.white54)),
              const SizedBox(height: 30),
              Center(
                  child: GlassPanel(
                      child: Column(children: [
                const Text("Globální Puls",
                    style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 20),
                const GlobalPulseRadar(),
                const SizedBox(height: 20),
                Text("Aktivních poutníků: 12,450",
                    style: TextStyle(color: state.moodColor))
              ]))),
              const SizedBox(height: 20),
              GlassPanel(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    const Text("Efekt Modlitby (Před vs. Po)",
                        style: TextStyle(
                                  ...
                                  children: [
                                    Row(
                                        ...
                                        children: [
                                          Container(
                                              width: 12,
                                              height: state.moodBefore[i] * 100,
                                              color: Colors.red
                                                  .withValues(alpha: 0.5)),
                                          const SizedBox(width: 4),
                                          Container(
                                              width: 12,
                                              height: state.moodAfter[i] * 100,
                                              color: Colors.green)
                                        ]),
                                    const SizedBox(height: 5),
                                    Text("D${i + 1}",
                    ...
                    const Row(children: [
                      ...
                      SizedBox(width: 10),
                      Text("Průměrný pokles napětí o 42%",
                          style: TextStyle(
              ...
              GlassPanel(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    const Text("Psychologický Profil",
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 15),
                    ...state.emotionDistribution.entries.map((e) => Padding(
              ...
              child: Row(
                  ...
                  children: [
                    Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text("Tvůj příspěvek",
                              style: TextStyle(color: Colors.white70)),
                          Text("${state.totalImpactMoney.toInt()} Kč",
                              style: const TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return BackdropFilter(
        ...
        child: Container(
            ...
            child: Column(children: [
              const SizedBox(height: 30),
              Icon(Icons.auto_awesome, size: 50, color: state.moodColor)
                  .animate(onPlay: (c) => c.repeat(reverse: true))
                  .scale(),
              const SizedBox(height: 20),
              Text("AURA AI", style: GoogleFonts.cinzel(fontSize: 24)),
              Expanded(
                  child: ListView(
              ...
              Padding(
                  ...
                  child: TextField(
                      onSubmitted: (val) =>
                          context.read<AppState>().sendMessage(val),
                      style: const TextStyle(color: Colors.white),
